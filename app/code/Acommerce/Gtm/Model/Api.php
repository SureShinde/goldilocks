...
use Acommerce\Gtm\lib\Google\Client as Google_Client;

/**
 * Class \Acommerce\Gtm\Model\Api
 */
class Api extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function getClient()
    {
        if (!$this->client) {
            ...
            $redirectUrl = $this->_urlBuilder->getUrl("adminhtml/system_config/edit", array('section' => 'Acommerce_Gtm'));
    ...
    protected function _getExistingVariables($accountId, $containerId)
    {
        ...
        try {
            ...
            throw new \Exception('Api error on variable listing' . $e->getMessage());
        }

        if ($response->getStatus() != 200) {
            throw new \Exception('Api error on variable listing');
        }
    ...
    protected function _getExistingTriggers($accountId, $containerId)
    {
        ...
        try {
            ...
            throw new \Exception('Api error on trigger listing' . $e->getMessage());
        }

        if ($response->getStatus() != 200) {
            throw new \Exception('Api error on trigger listing');
        }
    ...
    protected function _getExistingTags($accountId, $containerId)
    {
        ...
        try {
            ...
            throw new \Exception('Api error on tag listing' . $e->getMessage());
        }

        if ($response->getStatus() != 200) {
            throw new \Exception('Api error on tag listing');
        }
    ...
    protected function _createVariable($accountId, $containerId, $options)
    {
        ...
        try {
            ...
            throw new \Exception('Api error on variable creation ' . $options['name'] . ' ' . $e->getMessage());
        }

        if ($response->getStatus() != 200) {
            throw new \Exception('Api error on variable creation' . $options['name'] . ' ');
        }
    ...
    protected function _createTrigger($accountId, $containerId, $options)
    {
        ...
        try {
            ...
            throw new \Exception('Api error on trigger creation ' . $options['name'] . ' ' . $e->getMessage());
        }

        if ($response->getStatus() != 200) {
            throw new \Exception('Api error on trigger creation' . $options['name'] . ' ');
        }
    ...
    protected function _createTag($accountId, $containerId, $options)
    {
        ...
        try {
            ...
            throw new \Exception('Api error on tag creation ' . $options['name'] . ' ' . $e->getMessage());
        }

        if ($response->getStatus() != 200) {
            throw new \Exception('Api error on tag creation' . $options['name'] . ' ');
        }
