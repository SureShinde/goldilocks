<?php
namespace Acommerce\Gtm\lib\Google;
/*
...
use \Acommerce\Gtm\lib\Google\Config as Google_Config;
use \Acommerce\Gtm\lib\Google\Auth\GoogleAuthAbstract as Google_Auth_Abstract;
use \Acommerce\Gtm\lib\Google\Auth\OAuth2 as Google_Auth_OAuth2;
use \Acommerce\Gtm\lib\Google\IO\Curl as Google_IO_Curl;
use \Acommerce\Gtm\lib\Google\IO\GoogleIOAbstract as Google_IO_Abstract;
use \Acommerce\Gtm\lib\Google\Logger\GoogleLoggerAbstract as Google_Logger_Abstract;
use \Acommerce\Gtm\lib\Google\Http\Request as Google_Http_Request;
use \Acommerce\Gtm\lib\Google\Exception as Google_Exception;
  ...
  public function __construct($config = null)
  {
    ...
    if ($config->getIoClass() == Google_Config::USE_AUTO_IO_SELECTION) {
      if (function_exists('curl_version') && function_exists('curl_exec')
          && !$this->isAppEngine()) {
        $config->setIoClass("Acommerce\Gtm\lib\Google\IO\Curl");
      } else {
