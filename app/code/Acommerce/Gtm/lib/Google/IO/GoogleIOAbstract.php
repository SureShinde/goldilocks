...
use Acommerce\Gtm\lib\Google\Http\CacheParser as Google_Http_CacheParser;
/*
...
abstract class GoogleIOAbstract
{
  ...
  {
    $this->client = $client;
    $timeout = $client->getClassConfig('Acommerce\Gtm\lib\Google\IO\GoogleIOAbstract', 'request_timeout_seconds');
    if ($timeout > 0) {
