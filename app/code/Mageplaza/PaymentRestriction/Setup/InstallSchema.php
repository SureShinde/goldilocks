...
namespace Mageplaza\PaymentRestriction\Setup;
...
/**
 * Class InstallSchema
 * @package Mageplaza\PaymentRestriction\Setup
 */
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_paymentrestriction_rule')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mageplaza_paymentrestriction_rule'))
                ...
                ->setComment('Payment Restriction Table');
