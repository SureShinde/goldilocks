...
namespace Ecombricks\StoreCommon\Plugin\Model\Dhl;

/**
 * DHL carrier plugin
 */
class Carrier extends \Ecombricks\Common\Plugin\Plugin
{
    ...
    {
        if (version_compare(\Magento\Framework\App\ObjectManager::getInstance()->get('\\Magento\\Framework\\App\\ProductMetadata')->getVersion(), '2.3.3', '>=')) {
