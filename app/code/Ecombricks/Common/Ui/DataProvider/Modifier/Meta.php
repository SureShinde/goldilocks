...
class Meta
{
     ...
     * @return string|null
     */
    public function findPath(array $indexes, string $startPath = null, string $internalPath = null): ?string
    {
     ...
     * @return array
     */
    public function findPaths(array $indexes, string $startPath = null, string $internalPath = null): array
    {
