 ...
 */
class CreateTable extends \Ecombricks\Common\Setup\Operation\AbstractOperation
{
     ...
     */
    protected function addColumn(\Magento\Framework\DB\Ddl\Table $tableDdl, array $column): \Ecombricks\Common\Setup\Operation\OperationInterface
    {
        $tableDdl->addColumn(
            $column['name'],
            $column['type'],
     ...
     * @return \Ecombricks\Common\Setup\Operation\OperationInterface
     */
    protected function addColumns(\Magento\Framework\DB\Ddl\Table $tableDdl): \Ecombricks\Common\Setup\Operation\OperationInterface
    {
     ...
     * @return \Ecombricks\Common\Setup\Operation\OperationInterface
     */
    protected function addIndex(\Magento\Framework\DB\Ddl\Table $tableDdl, array $index): \Ecombricks\Common\Setup\Operation\OperationInterface
    {
     ...
     * @return \Ecombricks\Common\Setup\Operation\OperationInterface
     */
    protected function addIndexes(\Magento\Framework\DB\Ddl\Table $tableDdl): \Ecombricks\Common\Setup\Operation\OperationInterface
    {
     ...
     * @return \Ecombricks\Common\Setup\Operation\OperationInterface
     */
    protected function addForeignKey(\Magento\Framework\DB\Ddl\Table $tableDdl, array $foreignKey): \Ecombricks\Common\Setup\Operation\OperationInterface
    {
     ...
     * @return \Ecombricks\Common\Setup\Operation\OperationInterface
     */
    protected function addForeignKeys(\Magento\Framework\DB\Ddl\Table $tableDdl): \Ecombricks\Common\Setup\Operation\OperationInterface
    {
