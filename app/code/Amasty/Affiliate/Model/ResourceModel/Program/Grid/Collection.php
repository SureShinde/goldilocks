...
namespace Amasty\Affiliate\Model\ResourceModel\Program\Grid;
...
use Amasty\Affiliate\Model\ResourceModel\Program\Collection as ProgramCollection;

/**
 * @method Program[] getItems()
 */
class Collection extends ProgramCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $fetchStrategy,
            $eventManager,
            $customerIdAndGroupIdProgramFilter,
            $connection,
            $resource
        );
