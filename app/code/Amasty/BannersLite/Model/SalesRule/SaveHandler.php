...
class SaveHandler implements ExtensionInterface
{
    ...
    private function saveBannerData(\Magento\SalesRule\Model\Rule $entity, &$attributes)
    {
        ...
        if (!isset($attributes[BannerInterface::EXTENSION_CODE][0]['banner_image'])
            && !isset($attributes[BannerInterface::EXTENSION_CODE][1]['banner_image'])
            && !isset($attributes[BannerInterface::EXTENSION_CODE][2]['banner_image'])
        ) {
            return;
        }
