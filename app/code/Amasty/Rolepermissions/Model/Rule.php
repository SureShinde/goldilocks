...
{
    public const PRODUCT_ACCESS_MODE_ANY = '';

    public const PRODUCT_ACCESS_MODE_MY = 0;
    ...
    {
        parent::_construct();
        $this->_init(\Amasty\Rolepermissions\Model\ResourceModel\Rule::class);
                ...
                'external' => [
                    'store' => [
                        \Magento\Cms\Model\ResourceModel\Page::class =>
                            $this->getResource()->getTable('cms_page_store'),
                        \Magento\Cms\Model\ResourceModel\Block::class =>
                            $this->getResource()->getTable('cms_block_store'),
                        \Magento\Review\Model\ResourceModel\Rating::class =>
                            $this->getResource()->getTable('rating_store'),
                        \Magento\Review\Model\ResourceModel\Review::class =>
                            $this->getResource()->getTable('review_store'),
                        \Magento\Paypal\Model\ResourceModel\Billing\Agreement::class =>
                            $this->getResource()->getTable('checkout_agreement_store')
                    ],
                    'website' => [
                        \Magento\CatalogRule\Model\ResourceModel\Rule::class =>
                            $this->getResource()->getTable('catalogrule_website'),
                        \Magento\SalesRule\Model\ResourceModel\Rule::class =>
                            $this->getResource()->getTable('salesrule_website')
                    ]
                ],
                'internal' => [
                    'store' => [
