...
class General extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $events = $model->loadEventsByCriteria($model->getData('date'), $model->getStoreId());
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Event'),
                'title' => __('Event'),
                'values' => $model->eventsToOptions($events),
                'disabled' => $isElementDisabled,
                'value' => $model->getEventsIds(),
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Period'),
                'title' => __('Period'),
                'note' => __('Active events date range. Value of variable {{period}}, see below for complete list of variables. Leave blank to automatically generate starting and ending date (period) based on selected Event.'),
                'disabled' => $isElementDisabled,
        ...
        $fieldset = $form->addFieldset('list_fieldset', ['legend' => __('Row of Event List')]);
        ...
        $field = $fieldset->addField(
            ...
            [
                ...
                'values'    => [
                    ...
                    2 => __('Two Event In Row'),
                    3 => __('Three Event In Row'),
                ],
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => '
                    ...
                    You can also use variables <b>{{event2}}</b> and <b>{{event3}}</b> instead of <b>{{event}}</b> if you use "Two Event In Row" or "Three Event In Row" layout. <br />
