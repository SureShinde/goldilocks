...
class CreatePost extends \Magento\Customer\Controller\Account\CreatePost
{
    ...
    public function __construct(
        ...
        /**
         * @TODO Refactor when leave support of Magento 2.3.2 and less
         */
        if (version_compare($dataHelper->getMagento2Version(), '2.3.3', '>=')) {
            $parentMethodParameters[] = $customerRepository;
        }

        parent::__construct(...$parentMethodParameters);
    ...
    public function execute()
    {
        ...
        $parameters = $this->parametersFactory->create([$data]);
