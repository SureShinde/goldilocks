...
class CategoryEventHeaderStyle extends AbstractOptionSource
{
    ...
    public function toArray() : array
    {
        return [
            ...
            self::TEMPLATE_4 => __('Template 4'),
            self::TEMPLATE_5 => __('Template 5'),
        ];
    }
        ...
        return [
            [
                ...
                'image' => $this->viewAssetRepository->getUrl(
                    'Plumrocket_PrivateSale::images/event/header/style/category/ct-v1.jpg'
                ),
            ],
            [
                'label' => __('Template 2'),
                ...
                'image' => $this->viewAssetRepository->getUrl(
                    'Plumrocket_PrivateSale::images/event/header/style/category/ct-v2.jpg'
                ),
            ],
            [
                'label' => __('Template 3'),
                ...
                'image' => $this->viewAssetRepository->getUrl(
                    'Plumrocket_PrivateSale::images/event/header/style/category/ct-v3.jpg'
                ),
            ],
            [
                'label' => __('Template 4'),
                ...
                'image' => $this->viewAssetRepository->getUrl(
                    'Plumrocket_PrivateSale::images/event/header/style/category/ct-v4.jpg'
                ),
            ],
            [
                'label' => __('Template 5'),
                ...
                'image' => $this->viewAssetRepository->getUrl(
                    'Plumrocket_PrivateSale::images/event/header/style/category/ct-v5.jpg'
                ),
            ],
        ];
    }
