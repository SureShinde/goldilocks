define([
    ...
    return Component.extend({
        ...
        initObservable: function () {
            this._super()
                .observe(['email', 'emailFocused', 'isLoading','isButtonEnabledCheckout','isPasswordVisible','isSocialNetworkUsed','isLinkedInUsed', 'isZaloUsed','isLineUsed', 'isAppleUsed','isRedditUsed','isPinterestUsed','isTwitterUsed','isInstagramUsed','isFacebookUsed','isGoogleUsed','isAmazonUsed']);
            return this;
        },
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.type != null) {
                        ...
                        if (response.type == 'zalo') self.isZaloUsed(true);
