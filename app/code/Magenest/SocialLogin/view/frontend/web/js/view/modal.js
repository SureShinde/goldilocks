define([
    ...
    return Component.extend({
        ...
        forgotPasswordUrl: window.modal_content.customerForgotPasswordUrl,
        createNewAccount: window.modal_content.customerRegisterUrl,
        ...
        initialize: function () {
            var self = this;
            this._super();
            url.setBaseUrl(window.modal_content.baseUrl);
